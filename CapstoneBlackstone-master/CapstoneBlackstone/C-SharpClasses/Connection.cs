...
<<<<<<< HEAD
    ...
    Data Source=np-stem.temple.edu; Initial Catalog=CIS4396S01;Persist Security Info=True; Integrated Security=False;User ID=usrCIS4396S01;Password=<<PASSWORD HERE>>
    '*
    '***********************************************************************************************
*/
        ...
        public DBConnect()
        {
            String myConnectString = ConfigurationManager.ConnectionStrings["Connection_Database"].ToString();
            //Byte[] bArray = Convert.FromBase64String(ConfigurationManager.AppSettings["myPassword"]);
            //String myDecodedPass = Encoding.UTF8.GetString(bArray);
            //String SqlConnectString = (myConnectString + myDecodedPass);
            String SqlConnectString = (myConnectString);
